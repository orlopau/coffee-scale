...
const Recipe RECIPES[] = {
    ...
    {R_V60_KASUYA_NAME,
     ...
     P(AdjustableParameter::COFFEE_WEIGHT) | P(AdjustableParameter::RATIO),
     {
         {R_V60_KASUYA_0, RATIO(2.5), 0, SECONDS(45), false, false},
         {R_V60_KASUYA_1, RATIO(3), 0, SECONDS(45), false, false},
         {R_V60_KASUYA_2, RATIO(3), 0, SECONDS(45), false, false},
         {R_V60_KASUYA_3, RATIO(3), 0, SECONDS(45), false, false},
         {R_V60_KASUYA_4, RATIO(3), 0, SECONDS(45), false, false},
     }},
    {R_V60_RAO_NAME,
     R_V60_RAO_DESC,
