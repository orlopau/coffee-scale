...
const Recipe RECIPES[] = {
    {"AeroPress J.H.",
     ...
     P(AdjustableParameter::COFFEE_WEIGHT) | P(AdjustableParameter::RATIO),
     {
         ...
         {"Gently swirl the\nbrewer.", RATIO(0), 0, SECONDS(30), true, true},
         {"Press the plunger\nall the way in.", RATIO(0), 0, 0, true, false},
     }},
    {"V60 4-6 Method",
     "V60 recipe by\nTetsu Kasuya.",
     GRAMS(20),
     ...
     P(AdjustableParameter::COFFEE_WEIGHT) | P(AdjustableParameter::RATIO),
     {
         ...
         {"First two pours\nadjust sweetness and\nacidity.", RATIO(3), 0, SECONDS(45), false, false},
         {"Last pours\ncontrol strength.", RATIO(3), 0, SECONDS(45), false, false},
         {"Last pours\ncontrol strength.", RATIO(3), 0, SECONDS(45), false, false},
         {"Last pours\ncontrol strength.", RATIO(3), 0, SECONDS(45), false, false},
     }},
};