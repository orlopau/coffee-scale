...
RecipeSwitcherStep::RecipeSwitcherStep(RecipeStepState &state, const Recipe recipes[], const uint8_t recipeCount)
    : state(state), recipes(recipes), recipeCount(recipeCount), recipeIndex(0)
{
